...
const Hero = ({url, title, subitle}: HeroProps) => {
    return (
        <div className="relative flex items-center justify-center h-[30vh] md:h-[40vh] bg-cover bg-center " style={{ backgroundImage: `url(${url.src})`, backgroundPosition:"center" }}>
